...
`define OneHotLOWDO 10'b1000000_001
`define LOWREI 8'b10101001
`define OneHotLOWREI 10'b0100000_001
`define LOWMI 8'b10111001
`define OneHotLOWMI 10'b0010000_001
`define LOWFA 8'b11001001
`define OneHotLOWFA 10'b0001000_001
`define LOWSO 8'b11011001
`define OneHotLOWSO 10'b0000100_001
`define LOWLA 8'b11101001
`define OneHotLOWLA 10'b0000010_001
`define LOWTI 8'b11111001
`define OneHotLOWTI 10'b0000001_001
